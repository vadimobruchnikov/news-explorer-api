module.exports.ErrorMessages = {
  ...
  KEYWORD_DONT_FILL_ERROR: 'Не указана поисковая фраза[keyword]',
  TITLE_DONT_FILL_ERROR: 'Заголовок[title] должн быть заполнен',
  TEXT_DONT_FILL_ERROR: 'Текст статьи[text] должн быть не пустым',
